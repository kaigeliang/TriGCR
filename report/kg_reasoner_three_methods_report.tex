...
\footnotesize
\textbf{\color{blue!60!black}Reproducibility Artifact:} The cleaned source release, report PDF, LaTeX source, generated figures, and compact result summary are available as \textbf{TriGCR} at \href{https://github.com/kaigeliang/TriGCR}{github.com/kaigeliang/TriGCR}. The repository separates the three implemented method tracks: DVI, GraphLite/PathScorer, and embedding-guided KG-Trie construction.
\end{minipage}}
\end{center}
\vspace{0.45em}
]
