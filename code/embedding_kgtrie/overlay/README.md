...
CUDA 12.1 is recommended. The examples below use `requirements.txt` to install Python dependencies.

Step 1: Configure the proxy before downloading packages, if required by your network.
...
Step 3: Install Flash-attention for fast decoding (optional, GPU/CUDA only)
