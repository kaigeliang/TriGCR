...
| Routed DVI + Llama-3.1-8B | RoG-CWQ full test, `|C|=2` gate | 59.26 | -- | 56.22 | 54.63 | 6.58s |
| Routed DVI + Llama-2-7B | RoG-CWQ full test, `|C|=2` gate | 60.56 | -- | 56.92 | 54.51 | 6.53s |
...
|---|---:|---:|---:|---:|---:|
| Llama-3.1 | `|C| <= 1` | 59.03 | 54.80 | 54.33 | 8.54s |
| Llama-3.1 | `|C| = 2` | 59.26 | 56.22 | 54.63 | 6.58s |
| Llama-3.1 | `|C| <= 2` | 59.28 | 55.14 | 54.41 | 10.29s |
| Llama-3.1 | `|C| <= 3` | 58.92 | 54.63 | 53.87 | 11.27s |
| Llama-2 | `|C| <= 1` | 60.40 | 55.88 | 54.38 | 6.89s |
| Llama-2 | `|C| = 2` | 60.56 | 56.92 | 54.51 | 6.53s |
| Llama-2 | `|C| <= 2` | 60.45 | 55.68 | 54.40 | 7.16s |
| Llama-2 | `|C| <= 3` | 59.71 | 54.91 | 53.84 | 7.34s |
